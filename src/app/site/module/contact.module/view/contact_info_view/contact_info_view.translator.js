    ...
    switch (true) {
        case (lang === 'es'):
            language = {
                ...
                item4: 'Navega nuestros productos descargables LOGO. Trabajamos para darte y para darnos la mejor experiencia de usuario.',
        ...
        default:
            language = {
                ...
                item4: 'Browse our LOGO downloadable products. We work to give you and to give us the best user experience.',
