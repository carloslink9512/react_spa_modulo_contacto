                ...
                <div className='my-container'>
                    <div className='shared_footer_bottom_view-container'>
                        <div className='shared_footer_bottom_view-container-leftbox'>
                            ...
                            <span className='shared_footer_bottom_view-container-leftbox-item'>item 1</span>
                            <span className='shared_footer_bottom_view-container-leftbox-item'>item 2</span>
                            <span className='shared_footer_bottom_view-container-leftbox-item'>item 3</span>
                            <span className='shared_footer_bottom_view-container-leftbox-item'>item 4</span>
                            <span className='shared_footer_bottom_view-container-leftbox-item'>item 5</span>
                        </div>
                    </div>
                </div>
            </div>
